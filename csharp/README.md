...
> **Status: alpha.** Covers input, output, and tool evaluation (async, cancellable) with typed models and opt-out install telemetry. No streaming, output contracts, retries, or configurable timeouts yet - see the [capability matrix](../README.md#capability-matrix).
